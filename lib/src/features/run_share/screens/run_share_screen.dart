    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _Tab(
            label: '자유 2',
            selected: current == CardStyle.free2,
            onTap: () => onChanged(CardStyle.free2),
          ),
          _Tab(
            label: '차지 1',
            selected: current == CardStyle.chagi1,
            onTap: () => onChanged(CardStyle.chagi1),
          ),
          _Tab(
            label: '차지 2',
            selected: current == CardStyle.chagi2,
            onTap: () => onChanged(CardStyle.chagi2),
          ),
        ],
      ),
    );
